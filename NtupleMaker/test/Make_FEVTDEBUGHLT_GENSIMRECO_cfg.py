...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/FlatRandomPtGun_SinglePionMinus_fragment.py nevts:50'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SinglePionMinus_FEVTDEBUGHLT.root'),
    outputCommands = process.FEVTDEBUGHLTEventContent.outputCommands + [
        'keep recoPFRecHits_particleFlowRecHitECAL_*_*',
        'keep recoPFRecHits_particleFlowRecHitHBHE_*_*',
        'keep recoPFRecHits_particleFlowRecHitHF_*_*',
...
process.generator = cms.EDProducer("FlatRandomEGunProducer",
    ...
    PGunParameters = cms.PSet(
        ...
        MinE = cms.double(49.999),
        MaxE = cms.double(50.001),
        PartID = cms.vint32(-211)
    ),
    Verbosity = cms.untracked.int32(0),
    firstRun = cms.untracked.uint32(1),
    psethack = cms.string('pion minus e 0 to 50, eta 2p5 to 3p0')
)
